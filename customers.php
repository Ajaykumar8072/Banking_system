...
<body style="background-image : url(https://ak.picdn.net/shutterstock/videos/14657986/thumb/10.jpg); background-repeat: no-repeat;
                ...
                ?>
                            <tr style="color : white;">
                                ...
                                <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button
                                            type="button" class="btn" style="background-color : grey; ">Transfer
                                            money</button></a></td>
                            </tr>
                            <?php
                    }
